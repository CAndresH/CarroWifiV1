...
import kotlinx.android.synthetic.main.voice_control_activity.arrow_down
import kotlinx.android.synthetic.main.voice_control_activity.arrow_left
import kotlinx.android.synthetic.main.voice_control_activity.arrow_right
import kotlinx.android.synthetic.main.voice_control_activity.arrow_up
...
class VoiceControl : AppCompatActivity() {
    ...
    private fun onTouchAction(v: View, event: MotionEvent): Boolean {
        ...
        if (isTouchUp) {
            ...
            when (v.id) {
                //R.id.arrow_up2 -> arrow_right2.setTextColor(whiteColor)
                //R.id.arrow_right2 -> arrow_right2.setTextColor(whiteColor)
                //R.id.arrow_left2 -> arrow_left2.setTextColor(whiteColor)
