...
class Preferences(ctx: Context) {
    ...
    fun getPortVideo(): String = getSharedPreferencesValue(Constant.PORT_STORAGEVIDEO)
    fun getPortAudio(): String = getSharedPreferencesValue(Constant.PORT_STORAGEAUDIO)
    fun getPortTemp(): String = getSharedPreferencesValue(Constant.PORT_STORAGETEMP)
